...
export const recipes: Recipe[] = [
  ...
  },
  {
    ...
    story:
      "Zwischen den E-Seiten liegt nicht nur Omas Handschrift. Dieses Eiskonfekt wirkt wie ein Beitrag einer Gastautorin: praktisch, süß und perfekt für Besuch, der schon im Vorzimmer steht.",
    ...
    ingredients: [
      { name: "Kokosfett", amount: 120, unit: "g" },
      ...
      { name: "Vanillezucker", amount: 1, unit: "Pkg" },
      { name: "Kokosette", amount: 40, unit: "g", note: "optional zum Bestreuen" },
    ],
    steps: [
      { number: 1, instruction: "Kokosfett bei niedriger Hitze schmelzen. Beide Schokoladen darin langsam auflösen." },
      { number: 2, instruction: "Staubzucker, Kakao und Vanillezucker glatt einrühren." },
      { number: 3, instruction: "Masse in kleine Papierförmchen oder eine mit Backpapier ausgelegte Form gießen." },
      { number: 4, instruction: "Mit Kokosette bestreuen und mindestens 1 Stunde kalt stellen. In kleine Stücke schneiden." },
    ],
